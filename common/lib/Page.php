...
class Page{
    ...
    private $config  = array(
        'header' => '<a href="#">共 %TOTAL_ROW% 条记录</a>',
        'prev'   => '上一页',
        'next'   => '下一页',
        'first'  => '1...',
        'end'   => '尾页',
    ...
    private function url($page){
        return urldecode(str_replace(urldecode('[PAGE]'), $page, urldecode($this->url)));
    }
    ...
    public function show() {
        ...
        $this->url = Url::current($this->parameter);
        /* 计算分页信息 */
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<a href="#" class="current">' . $page . '</a>';
                }
            }
        }
        ...
        return  "<div class='item-page'><ul>{$page_str}</ul></div>";
    }
